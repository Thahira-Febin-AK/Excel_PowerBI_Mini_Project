...
###- Storytelling with Data: Each dashboard tells a focused story—from geographic disparities to economic influence and long-term progress.
###- Interactive Exploration: Filters and navigation buttons allow users to drill down into specific countries, years, and categories.
###- Goal-Oriented Design: Visuals like gauge charts and YoY growth tables emphasize progress tracking and accountability.
###- Business Intelligence Skills: Demonstrates proficiency in Power BI, DAX, Excel data cleaning, and dashboard design tailored for decision-makers.
